...
async function main() {
  try {
    console.log("Deploying GMX governance tokens to World Chain...");
    ...
    if (fs.existsSync(frontendConfigPath)) {
      ...
      frontendConfig = frontendConfig.replace(/GMX_TOKEN=.*/, `GMX_TOKEN=${gmx.address}`);
      fs.writeFileSync(frontendConfigPath, frontendConfig);
      console.log(`Updated frontend configuration with GMX token address`);
    }
