 ...
 * 
 * This is a fixed version with the correct WETH contract name.
 */
async function main() {
  console.log("======================================================");
  ...
  // Verify WETH - using correct contract name (WETH instead of WETH9)
  try {
    ...
    const weth = await ethers.getContractAt("WETH", deploymentData.WETH);
