...
async function main() {
  ...
  await wldPriceFeed.setPrice(ethers.utils.parseUnits("1.25", 8)); // Using the correct function name
  console.log("✅ WLD price set to $1.25");
  
  // Set WETH price to $3,000.00
  console.log("Setting WETH price to $3,000.00...");
  await wethPriceFeed.setPrice(ethers.utils.parseUnits("3000", 8)); // Using the correct function name
